...
func (_m *Decoder) NextToken() (interface{}, error) {
	ret := _m.Called()
...
func (_c *Decoder_NextToken_Call) Return(_a0 interface{}, _a1 error) *Decoder_NextToken_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Decoder_NextToken_Call) RunAndReturn(run func() (interface{}, error)) *Decoder_NextToken_Call {
	_c.Call.Return(run)
	return _c
}
