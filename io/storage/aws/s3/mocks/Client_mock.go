...
// PutObject provides a mock function for the type MockClient
func (_mock *MockClient) PutObject(ctx context.Context, params *s3.PutObjectInput, optFns ...func(*s3.Options)) (*s3.PutObjectOutput, error) {
	var tmpRet mock.Arguments
	if len(optFns) > 0 {
		tmpRet = _mock.Called(ctx, params, optFns)
	} else {
...
//   - optFns ...func(*s3.Options)
func (_e *MockClient_Expecter) PutObject(ctx interface{}, params interface{}, optFns ...interface{}) *MockClient_PutObject_Call {
	return &MockClient_PutObject_Call{Call: _e.mock.On("PutObject",
		append([]interface{}{ctx, params}, optFns...)...)}
}

func (_c *MockClient_PutObject_Call) Run(run func(ctx context.Context, params *s3.PutObjectInput, optFns ...func(*s3.Options))) *MockClient_PutObject_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockClient_PutObject_Call) Return(putObjectOutput *s3.PutObjectOutput, err error) *MockClient_PutObject_Call {
	_c.Call.Return(putObjectOutput, err)
	return _c
}

func (_c *MockClient_PutObject_Call) RunAndReturn(run func(ctx context.Context, params *s3.PutObjectInput, optFns ...func(*s3.Options)) (*s3.PutObjectOutput, error)) *MockClient_PutObject_Call {
	_c.Call.Return(run)
	return _c
}
