...
func TestBackupXDR_NewFlagSet(t *testing.T) {
	...
	assert.Equal(t, int64(2000), result.ReadTimoutMilliseconds, "The read-timeout flag should be parsed correctly")
...
func TestBackupXDR_NewFlagSet_DefaultValues(t *testing.T) {
	...
	assert.Equal(t, int64(1000), result.ReadTimoutMilliseconds, "The default value for read-timeout should be 1000")
