...
type InfoGetter interface {
	...
	StartBackup(ctx context.Context, namespace, bucket, region, profile string, jobID int) error
	StartRestore(ctx context.Context, namespace, bucket, region, profile string, jobID int) error
}
