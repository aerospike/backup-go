...
func TestSumBackupStats(t *testing.T) {
	...
	t.Run("single stat returns same values", func(t *testing.T) {
		...
		s.commonStats.ReadRecords.Add(50)
		s.commonStats.BytesWritten.Add(200)
		s.AddSIndexes(1)
		s.AddUDFs(2)
	...
	t.Run("multiple stats are summed", func(t *testing.T) {
		...
		s1.commonStats.ReadRecords.Add(5)
		s1.AddUDFs(1)
		...
		s2.commonStats.ReadRecords.Add(15)
		s2.commonStats.BytesWritten.Add(100)
		s2.AddSIndexes(2)
