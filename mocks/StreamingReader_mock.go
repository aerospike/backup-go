...
func (_m *MockStreamingReader) SetObjectsToStream(list []string) {
	_m.Called(list)
}

// MockStreamingReader_SetObjectsToStream_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SetObjectsToStream'
type MockStreamingReader_SetObjectsToStream_Call struct {
	*mock.Call
}

// SetObjectsToStream is a helper method to define mock.On call
//   - list []string
func (_e *MockStreamingReader_Expecter) SetObjectsToStream(list interface{}) *MockStreamingReader_SetObjectsToStream_Call {
	return &MockStreamingReader_SetObjectsToStream_Call{Call: _e.mock.On("SetObjectsToStream", list)}
}

func (_c *MockStreamingReader_SetObjectsToStream_Call) Run(run func(list []string)) *MockStreamingReader_SetObjectsToStream_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].([]string))
	})
	return _c
...
func (_c *MockStreamingReader_SetObjectsToStream_Call) Return() *MockStreamingReader_SetObjectsToStream_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockStreamingReader_SetObjectsToStream_Call) RunAndReturn(run func([]string)) *MockStreamingReader_SetObjectsToStream_Call {
	_c.Call.Return(run)
	return _c
}
