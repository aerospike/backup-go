...
func (_m *MockRestorer) GetStats() *models.RestoreStats {
	...
	if rf, ok := ret.Get(0).(func() *models.RestoreStats); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockRestorer_GetStats_Call) Return(_a0 *models.RestoreStats) *MockRestorer_GetStats_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_c *MockRestorer_Wait_Call) Return(_a0 error) *MockRestorer_Wait_Call {
	_c.Call.Return(_a0)
	return _c
}
